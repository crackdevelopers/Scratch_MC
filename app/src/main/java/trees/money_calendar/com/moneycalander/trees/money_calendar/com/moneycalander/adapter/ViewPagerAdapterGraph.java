...
import trees.money_calendar.com.moneycalander.trees.money_calendar.com.moneycalander.fragments.NetResult;
 ...
 */
public class ViewPagerAdapterGraph extends FragmentStatePagerAdapter
{
    ...
    * This returns the title for the tab strips of the current fragment
    ...
    int noOfTabs;
    public ViewPagerAdapterGraph(FragmentManager fm, CharSequence mTitles[], int noOfTabs)
    {
        super(fm);
    ...
    {
        if(i==0) return new Incoming();
        if(i==1) return new OutGoing();
        if(i==2) return new NetResult();
        return null;
    }
